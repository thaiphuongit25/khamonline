...
public class UploadController extends BaseController {
    ...
    static {
        errorInfo.put("SUCCESS", "Thành Công"); //默认成功
        errorInfo.put("NOFILE", "Miền tải tệp lên không được bao gồm");
        errorInfo.put("TYPE", "Định dạng tệp không được phép");
        errorInfo.put("SIZE", "Kích thước tệp vượt quá giới hạn, hỗ trợ tối đa là 2Mb");
        errorInfo.put("ENTYPE", "Lỗi ENTYPE loại yêu cầu");
        errorInfo.put("REQUEST", "Tải lên yêu cầu ngoại lệ");
        errorInfo.put("IO", "IO ngoại lệ");
        errorInfo.put("DIR", "Tạo thư mục không thành công");
        errorInfo.put("UNKNOWN", "sai lầm không rõ");
    }
