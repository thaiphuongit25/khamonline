...
+---------------------------------------------------------------------------
*/
package com.mtons.Khamonline.web.formatter;
...
public class JsonUtils {
	...
	public static String toJson(Object obj) {
		try {
			...
			throw new RuntimeException("Không chuyển đổi được các ký tự json!");
		}
	}
	...
	public <T> T toObject(String json, Class<T> clazz) {
		try {
			...
			throw new RuntimeException("Không thành công khi chuyển đổi các ký tự json thành các đối tượng!");
		}
	}
