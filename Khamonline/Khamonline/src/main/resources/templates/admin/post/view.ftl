...
<section class="content-header">
    <h1>Người viết bài</h1>
    <ol class="breadcrumb">
        <li><a href="${base}/admin">Trang Chủ</a></li>
        <li><a href="${base}/admin/post/list">Quản lý bài viết</a></li>
        <li class="active">Biên tập viên</li>
    </ol>
</section>
            ...
            <div class="col-md-9 side-left">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Biên tập viên</h3>
                    </div>
                    <div class="box-body">
                        <div class="form-group">
                            <input type="text" class="form-control" name="title" value="${view.title}" maxlength="64" placeholder="Tiêu đề bài viết" required >
                        </div>
                        <div class="form-group">
                ...
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="tags" data-role="tagsinput" class="form-control" value="${view.tags}" placeholder="Nhập giá tiền!">
                        </div>
                    </div>
                    <div class="box-footer">
                        <button type="button" data-status="1" class="btn btn-default btn-sm" event="post_submit">Hủy Bỏ</button>
                        <button type="button" data-status="0" class="btn btn-primary btn-sm pull-right" event="post_submit">Đồng Ý</button>
                    </div>
                </div>
            </div>
        </form>
