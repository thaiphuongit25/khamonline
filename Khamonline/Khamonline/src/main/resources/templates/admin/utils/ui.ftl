...
<head>
    ...
    <title>Quản lý hệ thống - ${options['site_name']}</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="${base}/index" class="logo">
            <span class="logo-mini">Khamonline</span>
            <span class="logo-lg">KhamOnline</span>
        </a>
        <nav class="navbar navbar-static-top">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    <li><a href="/" title="Jump to the foreground" target="_blank"><i class="fa fa-television"></i></a></li>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="${base}/settings/profile" class="btn btn-default btn-flat">Thông tin cá nhân</a>
                                </div>
                                <div class="pull-right">
                                    <a href="${base}/logout" class="btn btn-default btn-flat">Đăng xuất</a>
                                </div>
                            </li>
                        </ul>
                    </li>
    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                    <a href="${base}/admin" class="active"><i class="fa fa-dashboard"></i><span>Bảng điều khiển</span></a>
                </li>
                <@menus>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2020 <a href="#">Khamonline</a>.</strong> All rights reserved.
    </footer>
</body>
</html>
</#macro>
