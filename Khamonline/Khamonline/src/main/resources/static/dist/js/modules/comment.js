...
define(function(require, exports, module) {
	...
	var Comment = {
        ...
        post: function (toId, pid, text) {
        	...
        	if (text.length == 0) {
        		layer.msg('Vui lòng nhập nội dung trước khi gửi!', {icon: 2});
        		return false;
        	}
        	if (text.length > 255) {
        		layer.msg('Nội dung quá dài, vui lòng nhập trong vòng 140 ký tự', {icon: 2});
        		return false;
        	}
